...
\ifdefined\apaformat
  \title{Fast Uncertainty Quantification in Cognitive Modeling}
  % APA-specific formatting
  \shorttitle{Fast Uncertainty Quantification}
...
\else
  ...
  \leadauthor{Vandekerckhove} 
   ...
   \dates{Draft of \today{}.  Planned outlet: \textit{Behavior Research Methods}.}
